...
# /home/ganlu/trained_models_dsf/stf/output/train_stf/EXP_STF_SNOW_NIGHT_CBAM/model_best.pth.tar \
# --split test --num-classes 4 \
# --wandb --model efficientdetv2_dt --batch-size=1 --branch fusion --att_type cbam | tee fixed_fusion_cbam_stf_cls.txt
...
--checkpoint /home/ganlu/trained_models_dsf/stf/output/train_stf/EXP_STF_FULL_CBAM/model_best.pth.tar \
--split test --num-classes 4 \
--model efficientdetv2_dt --batch-size=1 --branch fusion --att_type cbam | tee fixed_fusion_cbam_stf_pascal.txt
...
# --checkpoint /home/ganlu/trained_stf_clear/EXP_CLEAR3_STF_CLEAR_CBAM/model_best.pth.tar \
# --split test --num-classes 4 \
# --wandb --model efficientdetv2_dt --batch-size=1 --branch fusion --att_type cbam | tee fixed_fusion_cbam_stf_pascal.txt
